...
<div class="top-mv__slide pc">
  <figure><img src="./images/top/mv03.jpg" alt="" class="w_100 pc"><p class="annotation white">エントランス完成予想図</p></figure>
  <figure><img src="./images/top/mv04.jpg" alt="" class="w_100 pc"><p class="annotation white">image photo</p></figure>
  <figure><img src="./images/top/mv05.jpg" alt="" class="w_100 pc"><p class="annotation white">モデルルームDCタイプ（2024年8月撮影）</p></figure>
  ...
  <div class="ttop-mv__slide sp tb">
  <figure><img src="./images/top/mv03-sp.jpg" alt="" class="w_100 sp tb"><p class="annotation white">エントランス完成予想図</p></figure>
  <figure><img src="./images/top/mv04-sp.jpg" alt="" class="w_100 sp tb"><p class="annotation white">image photo</p></figure>
  <figure><img src="./images/top/mv05-sp.jpg" alt="" class="w_100 sp tb"><p class="annotation white">モデルルームDCタイプ（2024年8月撮影）</p></figure>
  ...
  <div class="points">
    <ul class="lists wrap">
      ...
      <li class="list03 text02"><span class="big color">ZEH-M Oriented</span><br><span class="big">「<span class="color">低炭素建築物</span>」</span>認定取得予定</li>
    </ul>
  </div><!-- points -->
  ...
  <section class="site-contents wrap">
    ...
    <ul class="lists clearfix">
      ...
      <li>
        <a href="https://www.sumitomo-rd-mansion.jp/tokai/higashibetsuin/list.php" target="_blanc">
