<!doctype html><?php
 $page_settings = array(
  ...
  "page_class" => "",
  "url" => "",
  "title" => "【公式】シティタワー東別院｜東別院の新築マンション｜住友不動産",
  "keywords" => "シティタワー東別院,東別院 マンション,東別院 新築マンション,東別院,東別院駅,地下鉄名城線,名古屋市中区,マンション,新築マンション,分譲マンション,住友不動産",
  "description" => "地下鉄名城線「東別院駅」まで徒歩8分。住友不動産の新築マンションが東別院に誕生。【すみふ東別院】名古屋市中区のマンションなら住友不動産。",
...
<div class="top-mv__slide pc">
  <figure><img src="./images/top/mv01.jpg" alt="" class="w_100 pc"></figure>
  <figure><img src="./images/top/mv02.jpg" alt="" class="w_100 pc"></figure>
  </div><!--//top-mv -->
  <div class="top-mv__slide sp">
  <figure><img src="./images/top/mv01-sp.jpg" alt="" class="w_100 sp"></figure>
  <figure><img src="./images/top/mv02-sp.jpg" alt="" class="w_100 sp"></figure>
  </div><!--//top-mv -->
...
また、周辺環境・眺望は将来変わる場合があります。また、形状の細部および設備機器等については省略しております。<br>※本物件の東側接近地の一部は、事業主・住友不動産株式会社の所有地であり、将来宅地開発等が行われる計画があります。（2023年地点において、この計画に関わる建築概要等は未定です。また、この計画を変更中止することがあります。）
この計画が実現しますと今回分譲する東側の住戸の眺望、通風等に影響が生じる場合がありますので、予めご了承ください。</p>
</main>
