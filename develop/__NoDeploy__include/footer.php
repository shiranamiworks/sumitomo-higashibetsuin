<footer class="footer">
  ...
  <div class="footer-recommend">
    <div class="container">
      ...
      <div>
          <div class="cont">
            <figure><a href="/tokai/yagoto/" target="_blank"><img src="<?= $page_settings["directory_pos"]  ?>images/common/bana/img_recommend08.jpg" alt="シティハウス八事"></a></figure>
            <dl>
              <dt><a href="/tokai/yagoto/" target="_blank">シティハウス八事</a></dt>
              <dd>
                <p>交　通：地下鉄鶴舞線「八事」駅まで徒歩4分</p>
                <p>住　所：愛知県名古屋市天白区弥生が岡</p>
                <p>総戸数：44戸</p>
              </dd>
            </dl>
          </div>
        ...
        <div>
          <div class="cont">
            ...
            <dl>
              ...
              <dd>
                <p>交　通：地下鉄桜通線・鶴舞線「丸の内」駅まで徒歩4分</p>
...
<!-- //おススメ物件 -->
  ...
  <div class="footer-btn">
    ...
    <div class="fixed-btn">
      ...
      <div href="javascript:openfraijo();" class="fixed-btn__online">
        <p><img src="<?= $page_settings["directory_pos"]  ?>images/common/icn_btn02.png" alt="オンライン見学会予約"><br>オンライン<br>見学会予約</p>
      </div>
    ...
    <div id="spfraijo" class="sp">
			<a href="javascript:raijo();">来場予約</a>
			<a href="javascript:online();">オンライン見学会予約</a>
		</div>
  </div>
</footer>
