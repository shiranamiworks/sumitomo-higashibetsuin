...
<header id="header">
  <div class="header-wrapper d-flex align-items-center justify-content-between">
    ...
    <div class="header-right d-flex">
               <script type="text/javascript" src="/bukken_manage/bukken_manage_entry_button.cgi?AREA_CD=tokai&PROP_CD=higashibetsuin&LINK=header"></script>
      ...
      <nav>
        <ul>
          ...
          <li>
            ...
            <p href="<?= $page_settings["directory_pos"]  ?>design.html"><span class="f-en">DESIGN</span><br>デザイン</p>
          </li>
          <li>
          <!-- <a href="<?= $page_settings["directory_pos"]  ?>public.html"><span class="f-en">COMMON SPACE</span><br>共&#12132;空間</a> -->
          <p href="<?= $page_settings["directory_pos"]  ?>public.html"><span class="f-en">COMMON SPACE</span><br>共&#12132;空間</p>
          </li>
          <li>
        ...
        <ul>
          ...
          <li class="has-child">
            ...
            <div class="sub-menu">
              <a href="<?= $page_settings["directory_pos"]  ?>location01.html">進化する都心エリア</a>
              <a href="<?= $page_settings["directory_pos"]  ?>location02.html" class="finish">静穏な邸宅地</a>
            </div>
          </li>
          <li>
