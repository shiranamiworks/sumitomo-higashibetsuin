    ...
    <div class="container d-flex flex-wrap justify-content-between align-items-start">
        ...
        <ul>
          ...
          <li class="has-child">
            ...
            <div class="sub-menu">
              ...
              <a href="<?= $page_settings["directory_pos"]  ?>location02.html">歴史ある格調の地</a>
              <a href="<?= $page_settings["directory_pos"]  ?>location03.html" class="finish">ライフインフォメーション</a>
            </div>
          </li>
          <li>
      ...
      <div class="header-menu-right">
        <ul class="header-menu-btn">
          ...
          <li class="request bg_btn--request"><a href="javascript:siryo();"><p>資料請求</p></a></li>
        </ul>
