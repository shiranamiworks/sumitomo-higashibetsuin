    ...
    <div class="wrap">
      ...
      <ul class="lists list02">
        <li>
          ...
          <p class="lead">1階共用部の共用トイレ、共用水栓（散水栓、ゴミ置き場水栓）へは水道本管から給水ポンプを経由せずに給水しているので、万一の停電で給水ポンプが停止しても、水を使うことができます。<br><span>※被災の状況により水が使えない場合があります。</span></p>
        </li>
        <li>
      ...
      <ul class="lists list03">
        ...
        <li>
          ...
          <p class="lead">地震などの災害時に万一停電しても、共用部の一部設備［非常用エレベーター、 共用部照明の一部、共用部オートドアの一部、住戸への給水など］を約48時間稼動させるため、非常用発電機から電力を供給します。<br><span>※被災の状況により電力を供給できない場合があります。<br>※稼動時間は燃料満載時前提です。また使用状況により稼動時間が変わる場合があります。<br>※火災信号が入った場合には、法的な防災設備の稼動が優先されます。</span></p>
        </li>
      </ul>
      ...
      <ul class="lists list05">
        ...
        <li>
          ...
          <p class="lead">万一の地震時による家具転倒予防として、キッチンの壁面の一部に家具固定用下地補強を施しました。壁面の一部分にある下地補強に家具を固定することで家具が倒れにくくなり、住まう方の安全に配慮された仕様です。<br><span>※住戸タイプにより設置箇所は異なります。詳細は係員にお尋ねください。<br>※取付金具は別途お客様のご負担となります。</span></p>
          <div class="image">
