...
<main>
  ...
  <section class="station wrap clearfix">
    ...
    <div class="airport clearfix">
      ...
      <p class="caps">※1：※1：5駅6路線とは、地下鉄名城線「東別院」駅（徒歩8分）、地下鉄鶴舞線「大須観音」駅（徒歩12分）、地下鉄名城線・鶴舞線「上前津」駅（徒歩13分）、名鉄名古屋本線「山王」駅（徒歩14分）、
JR東海道本線・中央線、名鉄名古屋本線「金山」駅（徒歩14分）、地下鉄名城線・名港線「金山」駅（徒歩15分）のことです。<br>※掲載の所要時間は待ち時間・乗り換え時間を含んだ通勤時（カッコ内は日中平常時）の目安であり、時間帯により多少異なります。<br>※掲載の路線図は、一部路線・駅等を抜粋して表記しています。</p>
    </div><!-- airport -->
  </section><!-- station -->
