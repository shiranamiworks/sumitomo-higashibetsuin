<!doctype html><?php
 $page_settings = array(
  ...
  "page_class" => "",
  "url" => "",
  "title" => "アクセス｜【公式】シティタワー東別院｜東別院の新築マンション｜住友不動産",
  "keywords" => "アクセス,シティタワー東別院,東別院 マンション,東別院 新築マンション,東別院,東別院駅,地下鉄名城線,名古屋市中区,マンション,新築マンション,分譲マンション,住友不動産",
  "description" => "アクセスページ。地下鉄名城線「東別院駅」まで徒歩8分。住友不動産の新築マンションが東別院に誕生。【すみふ東別院】名古屋市中区のマンションなら住友不動産。",
  "add_stylesheet" => ["css/access.css","css/leaflet.css"],
  "add_script" =>  [],
    
  "logo_text" => "東別院駅徒歩8分｜シティタワー東別院｜東別院 新築マンション｜アクセス｜すみふ東別院｜住友不動産"
);
?>
...
<main>
  ...
  <header class="main-visual clearfix">
   ...
   <div class="image"><img src="./images/access/mv.png" alt="" class="pc"><img src="./images/access/mv-sp.png" alt="" class="sp"><p class="annotation white">image photo</p></div>
  </header><!-- main-visual -->
  ...
  <section class="station wrap clearfix">
    ...
    <div class="airport clearfix">
      ...
      <p class="caps">※1：5駅6路線とは、地下鉄名城線「東別院」駅、地下鉄鶴舞線「大須観音」駅、地下鉄名城線・鶴舞線「上前津」駅、名鉄名古屋本線「山王」駅、JR東海道本線・中央線、名鉄名古屋本線、地下鉄名城線・名港線「金山」駅のことです。<br>※掲載の所要時間は待ち時間・乗り換え時間を含んだ通勤時（カッコ内は日中平常時）の目安であり、時間帯により多少異なります。<br>※掲載の路線図は、一部路線・駅等を抜粋して表記しています。</p>
    </div><!-- airport -->
  </section><!-- station -->
  ...
  <section class="taxi clearfix">
    ...
    <p class="tit03">■「シティタワー東別院」までのタクシー料金シミュレーション（概算）</p>
    <ul>
      <li>
        <div class="image">
    ...
    <p class="caps">※タクシー料金は、初乗り500円の普通車（中型車）を日中時（深夜時は22時～5時）に一般道で利用した場合の参考例です。タクシー会社・走行ルートおよび交通状況によって料金は異なります。<br>※タクシーサイトより（2022年11月調べ）</p>
    </div>
  </section><!-- taxi -->
  ...
  <section class="car clearfix">
    ...
    <p class="caps">※掲載のカーアクセス図は、一部、道路・出入口・IC等を抜粋して表記しています。<br>※掲載の距離表示については地図上の概測距離を、高速道路は「ドラぷら（NEXCO東日本）」ホームページにて検索（2023年6月現在）したものです。</p>
    </div>
  </section><!-- car -->
...
<p class="page-annotation js-scroll wrap clearfix">※距離表示については地図上の概測距離を、徒歩分数表示については80ｍを1分として算出し、端数を切り上げたものです。<br>※掲載の情報は2022年11月現在のものです。
</p></div>
</main>
