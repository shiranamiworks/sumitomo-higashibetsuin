  ...
  <section class="sections sec02 clearfix">
    <div class="wrap">
      ...
      <ul class="lists list02">
        <li class="full">
          <p class="tit-img">最大約2,500㎜?約2,650㎜の天井高<br><span>（リビング・ダイニング）</span></p>
          <p class="lead">天井高最大約2,500mm?約2,650mmを確保しました。天井を高くすることにより、同じ面積でも、空間の広がりが感じられるよう配慮した、開放感あふれる設計です。</p>
          <div class="image">
