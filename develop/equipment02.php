...
<main>
  ...
  <section class="sections sec01 clearfix">
    <div class="wrap">
      ...
      <ul class="lists list02 pc">
        ...
        <li>
          <div class="image">
            <img src="./images/equipment02/img05.jpg" alt="" class="img01">
            <p class="annotation gothic">（参考写真）</p>
          </div>
        </li>
        <li>
          <div class="image">
            <img src="./images/equipment02/img04.jpg" alt="" class="img02">
            <p class="annotation gothic">（参考写真）</p>
          </div>
        </li>
      </ul>
      ...
      <ul class="lists list08">
        ...
        <li>
          <p class="tit-img">断熱構造</p>
          <p class="lead">天井および外気に面する柱・梁・壁の室内側に約25㎜～約60㎜厚、最下階住戸の床下に約50㎜～約100㎜厚の断熱材を施工。また、屋上には約50㎜～約100㎜厚の断熱材を施しています。<br><span>※2階Abタイプは天井全面断熱20㎜施工。<br>※断熱材施工範囲は各住戸により異なります。詳細は係員にお尋ねください。</span></p>
        </li>
        <li>
        ...
        <li>
          ...
          <p class="lead">外壁のコンクリート厚は、約170㎜～約200㎜を確保し、室内側には断熱材を吹き付けて、省エネにも配慮しています。</p>
        </li>
      </ul>
    </div>
  </section><!-- sec01 -->
  ...
  <p class="page-annotation js-scroll wrap clearfix">※掲載の参考写真は本物件のモデルルームを撮影したものではありません。</p></div>
</main>
