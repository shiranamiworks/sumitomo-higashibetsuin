...
<main>
  ...
  <section class="intro sections clearfix">
    <div class="inner">
      ...
      <p class="text">リニア中央新幹線の開通を軸として、日本の3大経済圏の一体化を図るスーパー・メガリージョン構想。その主要駅である「名古屋」駅をはじめ、「栄」駅、「金山」駅周辺では、都心のポテンシャルをさらに高める数々の再開発計画が進行中。<br class="pc">この3大都心エリアをライフステージに、より豊かで快適な未来がここにはじまります。 </p>
    </div>
  ...
  <section class="areas area01 clearfix">
    ...
    <p class="lead sp">モダンな高層ビルが建ち並ぶドラマチックな景観が印象的な「名古屋」駅周辺。リニア中央新幹線開業に伴う経済圏の拡大、<br class="pc">国際的な都心拠点にふさわしい街づくりを目指し、さらなる開発が進行中です。</p>
      <ul class="list01">
        <li>
          <div class="image">
            <img src="./images/location01/area01-03.jpg" alt="">
          </div>
          <p class="name">JRゲートタワー（約3.1km）</p>
        </li>
        <li>
          <div class="image">
            <img src="./images/location01/area01-04.jpg" alt="">
          </div>
          <p class="name">JRセントラルタワーズ（約3.0km）</p>
        </li>
        <li>
          <div class="image">
            <img src="./images/location01/area01-05.jpg" alt="">
          </div>
          <p class="name">ミッドランドスクエア（約2.8km）</p>
        </li>
        <li>
          <div class="image">
            <img src="./images/location01/area01-06.jpg" alt="">
          </div>
      ...
      <div class="route sp-hide">
			...
			<div class="sp">
				<div id="scrollimagebox">
					<div id="wrap">
						<div class="box"><img src="images/location01/area01-07.jpg" alt="■リニア中央新幹線路線図" class="scrollimage" /></div>
						<div class="scrollimage_leftbox">
							<img src="images/location01/01/arw-l.png" alt="" />
						</div>
						<div class="scrollimage_rightbox">
							<img src="images/location01/01/arw-r.png" alt="" />
						</div>
					</div>
					<div class="scrollimage_caption"><p><img src="images/location01/icon_swipe.svg" alt="スライドで全体を表示できます" /></p></div>
				</div>
      </div>
      <ul class="list02">
        <li>
...
<br><span>※「栄地区グランドビジョン」出典：名古屋市ホームページより（2023年6月現在）。</span></p>
      <ul class="list01">
        ...
        <li>
          <div class="image">
            <img src="./images/location01/area02-04.jpg" alt="">
          </div>
          <p class="name">ナディアパーク<br>（約1,650m／徒歩21分）</p>
        </li>
        <li>
          <div class="image">
            <img src="./images/location01/area02-05.jpg" alt="">
          </div>
          <p class="name">松坂屋名古屋<br>（約1,800m／徒歩23分）</p>
        </li>
        <li>
          <div class="image">
            <img src="./images/location01/area02-06.jpg" alt="">
          </div>
  ...
  <section class="areas area03 clearfix">
    ...
    <div class="inner">
      ...
      <ul class="list04">
        <li>
          <div class="image">
            <img src="./images/location01/area03-04.jpg" alt="">
          </div>
          <p class="name">名古屋市音楽プラザ<br>（約990m／徒歩13分）</p>
        </li>
        <li>
          <div class="image">
            <img src="./images/location01/area03-05.jpg" alt="">
          </div>
          <p class="name">日本特殊陶業市民会館<br>（約1,090m／徒歩14分）</p>
        </li>
        <li>
          <div class="image">
            <img src="./images/location01/area03-06.jpg" alt="">
            <p class="annotation white">image photo</p>
          </div>
      ...
      <p class="lead">ファッション・雑貨、グルメ、サービス＆カルチャーなど、50店舗を超える様々なジャンルの店舗やワゴンショップで構成されたスタイリッシュな大型ショッピングモール。建物の1階中央にある開放的な広場では各種イベントも開かれ、ショッピングやレジャースポットとして多くの人々で賑わっています。</p>
      <ul class="list03">
        <li>
          <div class="image">
  ...
  <section class="areas area04 clearfix">
    ...
    <div class="inner">
      <ul class="list06">
        <li>
          <div class="image">
            <figure class="pc"><img src="./images/location01/area04-03.jpg" alt="" class="sp-hide"></figure>
            <figure class="tb"><img src="./images/location01/area04-03.jpg" alt="" class="zoomImg tb"></figure>
