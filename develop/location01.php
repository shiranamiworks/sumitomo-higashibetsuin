...
<main>
  ...
  <section class="intro sections clearfix">
    ...
    <div class="inner">
      ...
      <br>※3.ザ・ランドマーク名古屋栄（2026年夏頃開業予定）出典：三菱地所株式会社、Ｊ.フロント都市開発株式会社、日本郵政不動産株式会社、明治安田生命保険相互会社、株式会社中日新聞社プレスリリースより（2024年7月24日付）</p>
    </div>
  </section><!-- intro -->
...
<br><span>※「栄地区グランドビジョン」出典：名古屋市ホームページより（2023年6月現在）。</span></p>
      ...
      <p class="back-tit">都市機能を向上させる<br class="sp">超高層ビル建設計画</p>
      <ul class="list03">
        <li>
          <div class="image">
            <img src="./images/location01/area02-08.jpg" alt="">
            <p class="open">2024年<br>4月<br>OPEN</p>
          </div>
          <p class="name">中日ビル（約2,320m）</p>
          <p class="name">地上31階・地下4階建。商業施設、ホール、広場、オフィス、ホテルを擁する複合ビル</p>
        </li>
        <li>
          <div class="image">
          ...
          <p class="name">地上41階・地下4階建。商業施設、シネマコンプレックス、オフィス、高級ホテルを計画</p>
  ...
  <section class="areas area04 clearfix">
    ...
    <div class="inner">
      ...
      <p class="mini">※掲載の標高は「国土地理院ウェブサイト」にて検索（2023年6月現在）したものです。<br>（計測地/【シティタワー名古屋東別院】愛知県名古屋市中区橘2丁目3、【名古屋駅】：愛知県名古屋市中村区名駅1丁目1-4、【名古屋城】：愛知県名古屋市中区本丸1番1号、【栄駅】：名古屋市中区栄3丁目5-12、【金山駅】：愛知県名古屋市中区金山1丁目17-18、【熱田神宮】：愛知県名古屋市熱田区神宮1丁目1-1）</p>
    </div><!-- inner -->
...
<p class="page-annotation js-scroll wrap clearfix">※「シティタワー東別院」は「シティタワー名古屋東別院」に物件名を変更いたしました。<br>※掲載の環境写真は2023年6月に撮影。<br>※距離表示については地図上の概測距離を、徒歩分数表示については80ｍを1分として算出し、端数を切り上げたものです。<br>※掲載の情報は2023年9月現在のものです。<br>※掲載の施設内容等は将来変わる場合があります。</p></div>
</main>
