    ...
    <div class="wrap">
      ...
      <ul class="lists list01">
        ...
        <li>
          ...
          <p class="lead">24時間オンライン体制で、セントラル警備保障（株）（CSP）指令センターにつながっています。各住戸、共用部で警報が発信されると、セントラル警備保障（株）の警備員が現場に急行し、必要な通報などの対応を致します。また、警備業務明細書の規定に従い、事前にお預かりした専有部の鍵を使用した住戸内での対応、共用部設備の異常信号を受信した場合の現地確認等、迅速かつ適切な対処に貢献します。</p>
          <div class="image img01">
      ...
      <ul class="lists list02">
        <li>
          ...
          <div class="lead-box">
           ...
           <div class="image img01">
            <img src="./images/structure03/img02.jpg" alt="" class="">
           </div>
          </div>
        </li>
        <li>
