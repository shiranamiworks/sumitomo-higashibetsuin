...
<main>
    ...
    <h2 class="tit">Security</h2>
      ...
      <ul class="lists list01">
        <li>
          ...
          <p class="lead">一般のマンションに比べ不審者の侵入対策を強化し、主な来訪者のアプローチ上の2ヶ所にオートロックシステムを採用しました。住戸前のセキュリティを加え3段階のチェックで、不審者の侵入対策を強化しています。また留守中の来訪者も確認できる録画録音機能もついています。</span></p>
          </div>
        ...
        <div class="text">
          ...
          <p class="lead">24時間オンライン体制で、セントラル警備保障（株）（CSP）指令センターにつながっています。各住戸、共用部で警報が発信されると、セントラル警備保障（株）の警備員が現場に急行し、必要な通報などの対応を致します。また、警備業務明細書の規定に従い、事前にお預かりした専有部の鍵を使用した住戸内での対応、共用部設備の異常信号を受信した場合の現地確認等、迅速かつ適切な対処に貢献します。<img src="./images/structure03/img03-mark.png" alt="" class=""></p>
        </div>
          <div class="image img01">
  ...
  <p class="page-annotation js-scroll wrap clearfix">※「シティタワー東別院」は「シティタワー名古屋東別院」に物件名を変更いたしました。<br>※掲載の写真はモデルルーム（Db1タイプ）を撮影（2024年8月）したものです。<br>※設備・仕様はタイプにより異なります。<br>※掲載の参考写真は本物件のモデルルームを撮影したものではありません。</p></div>
</main>
